...
class EuroRackSkiff(Boxes):
    ...
    def render(self):
        ...
        self.rectangularWall(y + 2*t, 6, "feee", callback=[self.railHoles] , move="up")
        self.rectangularWall(y + 2*t, 6, "feee", callback=[self.railHoles] , move="up")
        self.rectangularWall(x, h, "fFeF", callback=[self.wallxCB(x)],
                             move="right")
        self.rectangularWall(y, h, "ffhf", callback=[self.wallyCB(y)], move="up")
        self.rectangularWall(y, h, "ffhf", callback=[self.wallyCB(y)])
        self.rectangularWall(x, h, "fFeF", callback=[self.wallxCB(x)],
                             move="left up")
